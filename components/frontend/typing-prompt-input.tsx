...
export default function TypingPromptInput() {
  const prompts = [
    "Search the web for the latest AI research papers on agent frameworks...",
    "Generate an image of a futuristic cityscape with flying cars...",
    "Analyze the sentiment of these customer reviews and summarize the findings...",
    "Send an email to the team about our upcoming product launch...",
    "Execute a shell command to check the server status...",
  ]
